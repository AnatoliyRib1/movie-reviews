...
import (
	...
	"github.com/AnatoliyRib1/movie-reviews/scrapper/ingesters"
	"github.com/AnatoliyRib1/movie-reviews/scrapper/models"
...
func NewIngestCmd(logger *slog.Logger) *cobra.Command {
	...
	cmd.Flags().StringVarP(&opts.URL, "url", "u", "http://localhost:8081", "API URL")
